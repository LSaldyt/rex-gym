...
class RexAltWalkEnv(rex_gym_env.RexGymEnv):
  ...
  """
    ...
    def reset(self):
        ...
        super(RexAltWalkEnv, self).reset(initial_motor_angles=self.init_pose, reset_duration=0.5)
        self.goal_reached = False
        self.is_terminating = False
        self._stay_still = False
    ...
    def _transform_action_to_motor_command(self, action):
        ...
        action = super(RexAltWalkEnv, self)._transform_action_to_motor_command(action)
        return action
